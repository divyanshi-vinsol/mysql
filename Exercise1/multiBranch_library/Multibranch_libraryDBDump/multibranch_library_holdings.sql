...
--
-- Host: 127.0.0.1    Database: multibranch_library
-- ------------------------------------------------------
...
CREATE TABLE `holdings` (
  ...
  KEY `Title` (`Title`),
  KEY `Branch` (`Branch`),
  CONSTRAINT `holdings_ibfk_1` FOREIGN KEY (`Title`) REFERENCES `titles` (`Title`),
  CONSTRAINT `holdings_ibfk_2` FOREIGN KEY (`Branch`) REFERENCES `branch` (`BCode`)
...
-- Dump completed on 2020-03-27 14:27:39
